...
export namespace OpenAPI {
  ...
  export type Document<T extends {} = {}> =
    | ConfigAPIV1.Document<T>
    | OpenAPIV2.Document<T>
    | OpenAPIV3.Document<T>
    | OpenAPIV3_1.Document<T>;
  export type Operation<T extends {} = {}> =
    | ConfigAPIV1.OperationObject<T>
  ...
  export type Parameter =
    ...
    | ConfigAPIV1.ReferenceObject
    | ConfigAPIV1.ParameterObject
  ...
  export type Parameters =
    ...
    | (ConfigAPIV1.ReferenceObject | ConfigAPIV1.ParameterObject)[];
