export declare namespace OpenAPI {
    type Document<T extends {} = {}> = ConfigAPIV1.Document<T> | OpenAPIV2.Document<T> | OpenAPIV3.Document<T> | OpenAPIV3_1.Document<T>;
    type Operation<T extends {} = {}> = ConfigAPIV1.OperationObject<T> | OpenAPIV2.OperationObject<T> | OpenAPIV3.OperationObject<T> | OpenAPIV3_1.OperationObject<T>;
    type Parameter = OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.ParameterObject | OpenAPIV3.ReferenceObject | OpenAPIV3.ParameterObject | ConfigAPIV1.ReferenceObject | ConfigAPIV1.ParameterObject | OpenAPIV2.ReferenceObject | OpenAPIV2.Parameter;
    type Parameters = (OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.ParameterObject)[] | (OpenAPIV3.ReferenceObject | OpenAPIV3.ParameterObject)[] | (OpenAPIV2.ReferenceObject | OpenAPIV2.Parameter)[] | (ConfigAPIV1.ReferenceObject | ConfigAPIV1.ParameterObject)[];
    interface Request {
        body?: any;
        headers?: object;
        params?: object;
...
export declare namespace ConfigAPIV1 {
